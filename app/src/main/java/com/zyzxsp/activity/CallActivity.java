...
import com.zyzxsp.DialFragment;
import com.zyzxsp.R;
                                ...
                                if (NemoSDKErrorCode.WRONG_PASSWORD == integer) {
                                  ...
                                  //  Toast.makeText(CallActivity.this, "wrong password", Toast.LENGTH_SHORT).show();
                                   ...
                                   // Toast.makeText(CallActivity.this, "network_unavailable", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(CallActivity.this, "云会议号没有录制权限", Toast.LENGTH_SHORT).show();
                                } else if (NemoSDKErrorCode.RECORD_STORAGE == integer) {
                                    Toast.makeText(CallActivity.this, "云会议号空间不足，请联系管理员", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
...
//                                            Toast.makeText(CallActivity.this, "the side is busy, please call later", Toast.LENGTH_SHORT).show();
                                        ...
                                        if("NORMAL_CONF_SESSION_EXCEED".equals(reason)){
                                            Toast.makeText(CallActivity.this, "您呼叫的会议已达最大支持人数", Toast.LENGTH_LONG).show();
                                        }
...
//                });
    ...
    public String callDisconnectReson(String reason){
        String ressonStr = "";

        if (reason.equals("NOT_LOGGED_IN")) {
            ressonStr="call canceled";
        }
        if (reason.equals("CANCEL")) {
            ressonStr="call canceled";
        }
